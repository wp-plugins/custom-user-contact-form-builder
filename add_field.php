...
$qrylastrow = "select count(*) from $cfp_fields where Form_Id = '".$_REQUEST['formid']."'"; 
...
if(isset($_REQUEST['action']) && $_REQUEST['action']=='delete')
{
	...
	if (!wp_verify_nonce($retrieved_nonce, 'delete_cfp_field' ) ) die( 'Failed security check' );

	$qry = "delete from $cfp_fields where Id=".$_REQUEST['id'];	
	$reg = $wpdb->query($qry);	
	wp_redirect('admin.php?page=cfp_manage_form_fields&form_id='.$_REQUEST['formid']);exit;
}
...
{
	$retrieved_nonce = $_REQUEST['_wpnonce'];
	if (!wp_verify_nonce($retrieved_nonce, 'save_cfp_add_field' ) ) die( 'Failed security check' );

$qry = "insert into $cfp_fields values('','".$_POST['form_id']."','".$_POST['select_type']."','".$_POST['field_name']."','".$_POST['field_value']."','".$_POST['field_class']."','".$_POST['field_maxLenght']."','".$_POST['field_cols']."','".$_POST['field_rows']."','".$_POST['field_Options']."','".$_POST['field_Des']."','".$_POST['field_require']."','".$_POST['field_readonly']."','".$_POST['field_visibility']."','".$ordering."')";
$row = $wpdb->query($qry);	
wp_redirect('admin.php?page=cfp_manage_form_fields&form_id='.$_POST['form_id']);exit;
}
...
<script>
    ...
    function getfields(a) {
			...
			if(a=='file')
			{
				jQuery('#optionsfield .cfp-label').html('Define allowed file types (file extensions). <small style="float:left;">(Separate multiple values by “|”. For example PDF|JPEG|XLS)</small>');
				jQuery('#optionsfield').show();
			...
			if(a != 'file')
			{
				jQuery('#optionsfield .cfp-label').html('Options: <small style="float:left;">(value seprated by comma ",")</small>');	
			}
			/*file addon end */
            if (a != 'term_checkbox') {
            ...
            if (a == 'term_checkbox') {
                jQuery('#desfield .cfp-label').html('<?php _e( 'Terms & Conditions', $textdomain ); ?>');
                jQuery('#namefield .cfp-label').html('<?php _e( 'Name', $textdomain ); ?>');
                jQuery('#visibilityfield').hide();
                jQuery('#rulesfield').hide();
                jQuery('#readonlyfield').hide();
                jQuery('#registrationformfield').hide();
...
<div class="cfp-main-form">
  ...
  <form method="post" action="" id="add_field_form">
    <div class="cfp-form-setting" id="selectfieldtype">
    ...
    <div class="cfp-form-setting" id="namefield">
      <div class="cfp-form-left-area">
        <div class="cfp-label">
    ...
    <div class="cfp-form-setting" id="optionsfield">
      <div class="cfp-form-left-area">
        <div class="cfp-label">
    ...
    <div class="cfp-form-setting" id="desfield">
      <div class="cfp-form-left-area">
        <div class="cfp-label">
    ...
    <div class="cfp-form-setting">
      <div class="toggle_button cfp-form-left-area">
        <div class="cfp-label"><?php _e( 'Advance Options', $textdomain ); ?></div>
        <span class="show_hide" id="plus"><?php _e( '+', $textdomain ); ?></span></div>
    </div>
    <div class="slidingDiv">
      <div class="cfp-form-setting" id="valuefield">
        <div class="cfp-form-left-area">
          <div class="cfp-label">
      ...
      <div class="cfp-form-setting" id="classfield">
        <div class="cfp-form-left-area">
          <div class="cfp-label">
      ...
      <div class="cfp-form-setting" id="maxlenghtfield">
        <div class="cfp-form-left-area">
          <div class="cfp-label">
            <?php _e( 'Maximum Length:', $textdomain ); ?>
          </div>
        </div>
        <div class="cfp-form-right-area upb_number">
      ...
      <div class="cfp-form-setting" id="colsfield">
        <div class="cfp-form-left-area">
          <div class="cfp-label">
      ...
      <div class="cfp-form-setting" id="rowsfield">
        <div class="cfp-form-left-area">
          <div class="cfp-label">
      ...
      <div class="cfp-form-setting" id="requirefield">
        <div class="cfp-form-left-area">
          <div class="cfp-label">
      ...
      <div class="cfp-form-setting" id="readonlyfield">
        <div class="cfp-form-left-area">
          <div class="cfp-label">
      ...
      <div class="cfp-form-setting" id="visibilityfield">
        <div class="cfp-form-left-area">
          <div class="cfp-label">
    ...
    <div class="cfp-form-footer">
      <div class="cfp-form-button">
     	 <?php wp_nonce_field('save_cfp_add_field'); ?>
        ...
        <input type="button" value="Cancel" class="cfp-back-button" name="field_back" id="field_back" onClick="backtoform(<?php if(isset($_REQUEST['formid'])) echo $_REQUEST['formid']?>)"  />
      </div>
...
<script type="text/javascript">
    function check(prev, formid) {
        ...
        jQuery.post('<?php echo get_option('siteurl').'/wp-admin/admin-ajax.php';?>?action=check_cfp_field_name&cookie=encodeURIComponent(document.cookie)', {
                'name': name,
                'prev': prev,
                'formid': formid
            },
    ...
    function backtoform(a) {
        window.location = '<?php  echo admin_url().'admin.php?page=cfp_manage_form_fields&form_id='?>' + a;
    }
</script>