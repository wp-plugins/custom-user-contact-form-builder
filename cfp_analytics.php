...
<a href="admin.php?page=cfp_Pro"><img src="<?php echo $path;?>images/Analytics_demo_banner.jpg" /></a></div>
  <div class="cfp-main-form" style="margin-top:10px;">
    ...
    <div class="cfp-add-new-button" style="float:left;">
...
<script type="text/javascript">
    ...
    function drawChart() {
      ...
      var chart = new google.visualization.BarChart(document.getElementById("cfp_barchart_values"));
...
<div class="cfp-main-form cfp-main-form2">
  ...
  <div id="cfp_barchart_values"> </div></div>
