    ...
    <div id="fields-contain">
      <div class="cfp-main-form">
        ...
        <div class="cfp-form-name-buttons">
          <div class="cfp-setting"><a href="admin.php?page=cfp_add_form&id=<?php echo $_REQUEST['form_id'];?>"><img src="<?php echo $path; ?>images/edit-button.png"></a></div>
        </div>
        <div  class="cfp-add-remove-field">
          <div class="cfp-add-field"><?php _e( 'Add Field', $textdomain ); ?></div>
          <div class="cfp-remove-field" style="display:none;">
...
echo $fieldnamehalf.'...';
		...
		{
			echo '<ul id="sortable" class="cfp_entries">
            <li class="rows">
...
<script>
    function add_field(type) {
        window.location = 'admin.php?page=cfp_add_field&type=' + type + '&formid=' + <?php echo $form_id; ?> ;
    }

    function redirectform(id) {
        window.location = 'admin.php?page=cfp_manage_form_fields&form_id=' + id;
    }
</script>
<script>
