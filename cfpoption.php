...
if(isset($_REQUEST['saveoption']))
{
	...
	cfp_add_option( 'autogeneratedepass', $_REQUEST['autogenerate_pass']);
	cfp_add_option( 'userautoapproval', $_REQUEST['user_auto_approval']);
...
<div class="cfp-main-form">
  ...
  <div class="option-main cfp-form-setting">
      ...
      <div class="user-group-option cfp-form-right-area">
        ...
        <option value="default" <?php if($cfp_theme=='default')echo 'selected';?>>Classic</option>
        <option value="simple" <?php if($cfp_theme=='simple')echo 'selected';?>>Default</option>
        </select>
      </div>
    </div>
