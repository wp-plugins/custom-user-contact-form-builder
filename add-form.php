...
if(isset($_POST['submit_form']) && trim($_POST['form_name'])!="")
{
	...
	{
	$qry = "insert into $cfp_forms values('','".$_POST['form_name']."','".$_POST['form_des']."','".$_POST['form_type']."','".$_POST['form_custom_text']."','".$_POST['welcome_email_subject']."','".$_POST['success_message']."','".$_POST['welcome_email_message']."','".$_POST['redirect_option']."','".$_POST['page_id']."','".$_POST['redirect_url']."','".$_POST['send_email']."')";	
	}
	else
	{
	$qry = "update $cfp_forms set form_name = '".$_POST['form_name']."',form_desc='".$_POST['form_des']."',form_type='".$_POST['form_type']."',custom_text='".$_POST['form_custom_text']."',cfp_welcome_email_subject='".$_POST['welcome_email_subject']."',success_message='".$_POST['success_message']."',cfp_welcome_email_message='".$_POST['welcome_email_message']."',redirect_option='".$_POST['redirect_option']."',redirect_page_id='".$_POST['page_id']."',redirect_url_url='".$_POST['redirect_url']."',send_email='".$_POST['send_email']."' where id='".$_POST['form_id']."'";	
	}
	$wpdb->query($qry);
