...
wp_enqueue_style( 'cfp-style-simple', plugin_dir_url(__FILE__) . 'css/cfp-style-simple.css');
    ...
    <div class="cfp_contact_form">
      ...
      <div class="formtable">
        ...
        <div class="cfp_input">
          ...
          <div class="cfp_error_text" id="nameErr"></div>
          <div class="cfp_error_text reg_frontErr" id="divuser_name" style="display:none;"><?php _e('Please enter a username.',$textdomain);?></div>
        </div>
      </div>
      <div class="formtable">
        <div class="cfp_label">
        ...
        <div class="cfp_input">
          ...
          <div class="cfp_error_text" id="emailErr"></div>
          <div class="reg_frontErr cfp_error_text" id="divuser_email" style="display:none;"><?php _e('Please enter an email address.',$textdomain);?></div>
        </div>
      </div>
      <?php
...
?>
      <div class="formtable">
        ...
        <div class="cfp_input">
          ...
          <div class="reg_frontErr cfp_error_text" id="divinputPassword" style="display:none;"><?php _e('Please enter a password.',$textdomain);?></div>
        </div>
      </div>
      <div class="formtable">
        <div class="cfp_label">
        ...
        <div class="cfp_input">
          ...
          <div class="reg_frontErr cfp_error_text" id="divuser_confirm_password" style="display:none;"><?php _e('Please enter a confirm password',$textdomain);?></div>
        </div>
      </div>
      <?php
}
...
?>
      <div class="formtable" style="display:none;">
        ...
        <div id="complexity" class="default" style="display:none;"></div>
        <div id="password_info" class="password-pro"><?php _e('At least 7 characters please!',$textdomain);?></div>
        <div class="reg_frontErr cfp_error_text" id="divinputPassword" style="display:none;margin: -27px 0 23px !important; margin-left: 258px !important;"><?php _e('Please enter a password.',$textdomain);?></div>
      </div>
      <div class="formtable" style="display:none;">
        <div class="cfp_label">
          <label for="user_confirm_password"><?php _e('Confirm Password',$textdomain);?><br>
        ...
        <div class="cfp_input">
          ...
          <div class="reg_frontErr cfp_error_text" id="divuser_confirm_password" style="display:none;margin: -27px 0 23px !important; "><?php _e('Please enter a confirm password.',$textdomain);?></div>
        </div>
      </div>
      <?php
}
...
if($row1->Type=='term_checkbox')
        ...
        <div class="formtable">
          <div class="cfp_label">
            ...
            <div class="reg_frontErr cfp_error_text" style="display:none;"></div>
          </div>
        </div>
        <?php }
        ...
        <div class="formtable">
          ...
          <div class="cfp_input upb_number">
	   ...
	   {?>
        <div class="formtable">
          ...
          <div class="cfp_input cfp_select">
      ...
      <?php if($enable_captcha=='yes') : ?>
      <div class="formtable" align="center"><div class="cfp_input cfp_input_captcha"> <?php echo recaptcha_get_html($publickey, $error); ?> </div></div>
    ...
    <div class="customupberror cfp_error_text" style="display:none"></div>
    <div class="UltimatePB-Button-area cfp_input cfp_input_submit" >
      <input type="submit" value="Submit" class="cfp_contact_submit" id="submit" name="submit"  <?php if($form_type=='reg_form'): ?>  onClick="return validateRegister()" <?php endif; ?> >
