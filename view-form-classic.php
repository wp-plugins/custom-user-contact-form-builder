...
wp_enqueue_style( 'cfp-style', plugin_dir_url(__FILE__) . 'css/cfp-style.css');
  ...
  <input type="hidden" value="<?php echo $detail['key'];?>" name="cfp_key" />
    ...
    <div id="main-upb-formm">
      ...
      <div class="formtable">
        ...
        <div class="input-box cfp_required">
      ...
      <div class="formtable">
        ...
        <div class="input-box cfp_required cfp_email">
...
?>
      <div class="formtable">
        ...
        <div class="input-box cfp_required cfp_password">
      ...
      <div class="formtable">
        ...
        <div class="input-box cfp_required cfp_confirmpassword">
...
if($row1->Type=='term_checkbox')
        ...
        <div class="lable-text">
          ...
          <div class="input-box <?php if($row1->Require==1)echo 'cfp_termboxrequired';?>">
          <div class="term-box">
            <input type="checkbox" value="<?php echo 'yes';?>" id="<?php echo $key;?>" name="<?php echo $key;?>"  class="regular-text <?php echo $row1->Class;?>">
          
            <label for="<?php echo $key;?>"><?php echo $row1->Name;?><?php if($row1->Require==1)echo '<sup class="cfp_estric">*</sup>';?></label></div>
        ...
        <div class="formtable">
          ...
          <div class="input-box <?php if($row1->Require==1)echo 'cfp_required';?>">
        ...
        <div class="formtable">
          ...
          <div class="input-box cfp_email <?php if($row1->Require==1)echo 'cfp_required';?>">
            <input type="text" class="regular-text <?php echo $row1->Class;?>" maxlength="<?php echo $row1->Max_Length;?>" value="<?php echo $value;?>" id="<?php echo $key;?>" name="<?php echo $key;?>" <?php if($row1->Readonly==1)echo 'readonly';?>>
            <div class="reg_frontErr custom_error cfp_error_text" style="display:none;"></div>
          </div>
        </div>
        ...
        <div class="formtable">
          ...
          <div class="input-box cfp_number <?php if($row1->Require==1)echo 'cfp_required';?>">
        ...
        <div class="formtable">
          ...
          <div class="input-box <?php if($row1->Require==1)echo 'cfp_textarearequired';?>">
        ...
        <div class="formtable">
          ...
          <div class="input-box radio-box <?php if($row1->Require==1)echo 'cfp_radiorequired';?>">
            <?php 
		...
		if($row1->Type=='checkbox')
	   {
        ...
        <div class="formtable">
          ...
          <div class="input-box cfp_checkbox <?php if($row1->Require==1)echo 'cfp_checkboxrequired';?>">
            <?php 
			$arr_radio = explode(',',$row1->Option_Value);
			$radio_count = 1;
			foreach($arr_radio as $radio)
	   ...
	   {?>
        <div class="formtable">
          ...
          <div class="input-box cfp_select <?php if($row1->Require==1)echo 'cfp_select_required';?>">
	   ...
	   {?>
        <div class="formtable">
          ...
          <div class="input-box cfp_select cfp_country <?php if($row1->Require==1)echo 'cfp_select_required';?>">
            <select class="regular-text <?php echo $row1->Class;?>" id="<?php echo $key;?>" name="<?php echo $key;?>" <?php if($row1->Readonly==1)echo 'disabled';?>>
    ...
    <div class="customcfperror" style="display:none"></div>
...
jQuery('.cfp_required').parent('.formtable').children('.lable-text').children('label').append('<sup class="cfp_estric">*</sup>');
jQuery('.cfp_select_required').parent('.formtable').children('.lable-text').children('label').append('<sup class="cfp_estric">*</sup>');
jQuery('.cfp_radiorequired').parent('.formtable').children('.lable-text').children('label').append('<sup class="cfp_estric">*</sup>');
jQuery('.cfp_checkboxrequired').parent('.formtable').children('.lable-text').children('label').append('<sup class="cfp_estric">*</sup>');
jQuery('.cfp_textarearequired').parent('.formtable').children('.lable-text').children('label').append('<sup class="cfp_estric">*</sup>');
