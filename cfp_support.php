...
<div class="support-available">
  ...
  <div class="link">
  <ul>
  <li><a href="http://cmshelplive.com/accounts/index.php?m=forum&action=viewboard&id=14" target="_blank">GENERAL QUESTIONS</a></li>
<li><a href="http://cmshelplive.com/accounts/index.php?m=forum&action=viewboard&id=13" target="_blank">INSTALLATION ISSUES</a></li>
<li><a href="http://cmshelplive.com/accounts/index.php?m=forum&action=viewboard&id=15" target="_blank">FEATURE REQUESTS</a></li>
<li><a href="http://cmshelplive.com/accounts/index.php?m=forum&action=viewboard&id=16" target="_blank">BUG REPORTS</a></li>
  </ul>
  </div>
</div>
