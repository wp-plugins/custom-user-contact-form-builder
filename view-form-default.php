...
wp_enqueue_style( 'cfp-style-default', plugin_dir_url(__FILE__) . 'css/cfp-style-default.css');
...
$select="select `value` from $cfp_option where fieldname='enable_captcha'";
$enable_captcha = $wpdb->get_var($select);
$qry="select `custom_text` from $cfp_forms where id=".$content['id'];
$custom_text = $wpdb->get_var($qry);
$qry="select `form_type` from $cfp_forms where id=".$content['id'];
$form_type = $wpdb->get_var($qry);
$qry="select `form_name` from $cfp_forms where id=".$content['id'];
$form_name = $wpdb->get_var($qry);

$qry="select `form_option` from $cfp_forms where id=".$content['id'];
...
$qry="select `value` from $cfp_option where fieldname='userip'";
...
$qry="select `value` from $cfp_option where fieldname='autogeneratedepass'";
$pwd_show = $wpdb->get_var($qry);
$qry="select `value` from $cfp_option where fieldname='userautoapproval'";
...
if(isset($_POST['submit']) && $submit==1 ) // Checks if the submit button is pressed or not
{
	...
	$stats_update = "update $cfp_stats set details ='".$stats_final_details."' where id=".$stats->id;
	$wpdb->query($stats_update);
	
	$qry1 = "select * from $cfp_fields where Form_Id= '".$content['id']."' and Type not in('heading','paragraph') order by ordering asc";
	...
	$insert_entries = "insert into $cfp_entries values('','".$content['id']."','".$form_type."','".$autoapproval."','".$entries."')";
...
<?php
	...
	$qry="SELECT success_message FROM $cfp_forms WHERE id=".$content['id'];
	...
	$qry="SELECT redirect_option FROM $cfp_forms WHERE id=".$content['id'];
	$redirect_option = $wpdb->get_var($qry);
	
	if($redirect_option=='url')
	{
		$qry="SELECT redirect_url_url FROM $cfp_forms WHERE id=".$content['id'];
		$url = $wpdb->get_var($qry);	
	}
	
	if($redirect_option == 'page')
	{
		$qry="SELECT redirect_page_id FROM $cfp_forms WHERE id=".$content['id'];
...
<?php
	  $qry="SELECT send_email FROM $cfp_forms WHERE id=".$content['id'];//Fetches Auto Responder enable or disalbe.
	  $send_email = $wpdb->get_var($qry);
	  if($send_email==1)
	  {
	  $qry="SELECT cfp_welcome_email_subject FROM $cfp_forms WHERE id=".$content['id'];//Fetches Auto Responder Subject from dashboard settings
	  ...
	  $qry1="SELECT cfp_welcome_email_message FROM $cfp_forms WHERE id=".$content['id'];//Fetches registration email body from dashboard settings
	  ...
	  {
		$qry1 = "select * from $cfp_fields where Form_Id= '".$content['id']."' and Type ='email' order by ordering asc limit 1";
	  ...
	  $qry="select `value` from $cfp_option where fieldname='adminnotification'";
	  ...
	  if($admin_notification=='yes')
	  {
		...
		if(!empty($entry))
		{
			...
			foreach($entry as $key => $val) 
			{
				...
				{
					$nameqry = "select Name from $cfp_fields where id=".$fieldid;
...
$insert="INSERT INTO $cfp_stats VALUES('','".$content['id']."','".$detail['key']."','".$details."')";
$wpdb->query($insert);
?>
  ...
  <input type="hidden" value="<?php echo $detail['key'];?>" name="cfp_key" />
   ...
   <div class="cfp_contact_form">
      ...
      <div class="formtable">
        ...
        <div class="cfp_input cfp_required">
          ...
          <div class="reg_frontErr cfp_error_text custom_error" style="display:none;" id="nameErr"></div>
        </div>
      </div>
      <div class="formtable">
        <div class="cfp_label">
        ...
        <div class="cfp_input cfp_required cfp_email">
          ...
          <div class="reg_frontErr cfp_error_text custom_error" style="display:none;" id="emailErr"></div>
        </div>
      </div>
      <?php
...
?>
      <div class="formtable">
        ...
        <div class="cfp_input cfp_required cfp_password">
          ...
          <div class="reg_frontErr cfp_error_text custom_error" style="display:none;"></div>
      ...
      <div class="formtable">
        ...
        <div class="cfp_input cfp_required cfp_confirmpassword">
          <input id="user_confirm_password" name="user_confirm_password" type="password"/>
          <div class="reg_frontErr cfp_error_text custom_error" style="display:none;"></div>
          <!--<div class="reg_frontErr cfp_error_text" id="divuser_confirm_password" style="display:none;"><?php _e('Enter the password again to confirm',$textdomain);?></div>-->
        </div>
      </div>
      <?php
}
...
?>
     <?php endif;  ?>      
      <!-- HTML for displaying custom fields in Registration form -->
        ...
        <?php 
$qry1 = "select * from $cfp_fields where Form_Id = '".$content['id']."' order by ordering asc";
$reg1 = $wpdb->get_results($qry1);
	 foreach($reg1 as $row1)
	 {
		 ...
		 {?>
        <div class="formtable cfp_heading">
		...
		if($row1->Type=='paragraph')
		 {?>
        <div class="formtable cfp_paragraph">
...
if($row1->Type=='term_checkbox')
		 {?>
        <div class="formtable">
          <div class="cfp_label <?php if($row1->Require==1)echo 'cfp_termboxrequired';?>">
            <input type="checkbox" value="<?php echo 'yes';?>" id="<?php echo $key;?>" name="<?php echo $key;?>"  class="regular-text <?php echo $row1->Class;?>">
   <label for="<?php echo $key;?>"><?php echo $row1->Name;?><?php if($row1->Require==1)echo '<sup class="cfp_estric">*</sup>';?></label>
            <div class="reg_frontErr custom_error cfp_error_text" style="display:none;"></div>
        ...
        <div class="formtable">
          ...
          <div class="cfp_input <?php if($row1->Require==1)echo 'cfp_required';?>">
        ...
        <div class="formtable">
          ...
          <div class="cfp_input cfp_email <?php if($row1->Require==1)echo 'cfp_required';?>">
            <input type="text" class="regular-text <?php echo $row1->Class;?>" maxlength="<?php echo $row1->Max_Length;?>" value="<?php echo $value;?>" id="<?php echo $key;?>" name="<?php echo $key;?>" <?php if($row1->Readonly==1)echo 'readonly';?>>
            <div class="reg_frontErr custom_error cfp_error_text" style="display:none;"></div>
          </div>
        </div>
        ...
        <div class="formtable">
          ...
          <div class="cfp_input cfp_number <?php if($row1->Require==1)echo 'cfp_required';?>">
            <input type="text" class="cfp_number regular-text <?php echo $row1->Class;?>" maxlength="<?php echo $row1->Max_Length;?>" value="<?php echo $value;?>" id="<?php echo $key;?>" name="<?php echo $key;?>" <?php if($row1->Readonly==1)echo 'readonly';?>>
            <div class="reg_frontErr custom_error cfp_error_text" style="display:none;"></div>
          </div>
        </div>
        <?php }
        ...
        <div class="formtable">
          ...
          <div class="cfp_input <?php if($row1->Require==1)echo 'cfp_textarearequired';?>">
        ...
        <div class="formtable">
          ...
          <div class="cfp_input <?php if($row1->Require==1)echo 'cfp_radiorequired';?>">
            <?php 
		...
		if($row1->Type=='checkbox')
	   {
        ...
        <div class="formtable">
          ...
          <div class="cfp_checkbox <?php if($row1->Require==1)echo 'cfp_checkboxrequired';?>">
            <?php 
			$arr_radio = explode(',',$row1->Option_Value);
			$radio_count = 1;
			foreach($arr_radio as $radio)
	   ...
	   {?>
        <div class="formtable">
          ...
          <div class="cfp_input cfp_select <?php if($row1->Require==1)echo 'cfp_select_required';?>">
	   ...
	   {?>
        <div class="formtable">
          ...
          <div class="cfp_input cfp_select cfp_country <?php if($row1->Require==1)echo 'cfp_select_required';?>">
            <select class="regular-text <?php echo $row1->Class;?>" id="<?php echo $key;?>" name="<?php echo $key;?>" <?php if($row1->Readonly==1)echo 'disabled';?>>
      ...
      <div class="formtablee" align="center"><div class="cfp_input cfp_input_captcha"> <?php echo recaptcha_get_html($publickey, $error); ?> </div></div>
      <div class="reg_frontErr custom_error cfp_error_text" id="divrecaptcha_response_field" style="display:none;"></div>
    ...
    <div class="customcfperror cfp_error_text" style="display:none"></div>
    <div class="UltimatePB-Button-area cfp_input cfp_input_submit" >
      <input type="submit" value="<?php if($submit_button_label!="")echo $submit_button_label;else echo 'Submit'?>" class="cfp_contact_submit" id="submit" name="submit">
...
<script language="javascript" type="text/javascript">
    ...
    function validete_userName() {
        jQuery.ajax({
            type: "POST",
            url: '<?php echo get_option('siteurl').'/wp-admin/admin-ajax.php';?>?action=cfp_ajaxcalls&cookie=encodeURIComponent(document.cookie)&function=validateUser&name=' + jQuery("#user_name").val(),
    ...
    function validete_email() //AJAX email validation
        {
            jQuery.ajax({
                type: "POST",
                url: '<?php echo get_option('siteurl').'/wp-admin/admin-ajax.php';?>?action=cfp_ajaxcalls&cookie=encodeURIComponent(document.cookie)&function=validateEmail&email=' + jQuery("#user_email").val(),
                success: function (serverResponse) {
                    if (serverResponse == "true") {
                        email = false;
...
<script>
    ...
    jQuery('#cfp_contact_form').submit(function () {
		...
		if(password !="")
		{
			if(passwordlength < 7)
			{
				jQuery('.cfp_password').children('.custom_error').html('<?php _e('Your password should be at least 7 characters long.',$textdomain);?>');
				jQuery('.cfp_password').children('.custom_error').show();
			}
			if(password != confirmpassword)
			{
				jQuery('.cfp_confirmpassword').children('.custom_error').html('<?php _e('Password and confirm password do not match.',$textdomain);?>');
				jQuery('.cfp_confirmpassword').children('.custom_error').show();
			}
		}
		<?php endif; ?>
		
        jQuery('.cfp_email').each(function (index, element) {
		...
		/*file addon start */
		 jQuery('.cfp_file').each(function (index, element) {
		...
		/*file addon end */
        jQuery('.cfp_number').each(function (index, element) { //Validation for number type custom field
		...
		jQuery('.cfp_required').each(function (index, element) { //Validation for number type custom field
		...
		jQuery('.cfp_select_required').each(function (index, element) { //Validation for number type custom field
		...
		jQuery('.cfp_textarearequired').each(function (index, element) { //Validation for number type custom field
		...
		jQuery('.cfp_checkboxrequired').each(function (index, element) { //Validation for number type custom field
		...
		jQuery('.cfp_termboxrequired').each(function (index, element) { //Validation for number type custom field
		var checkboxlenght = jQuery(this).children('input[type="checkbox"]:checked');
		...
		jQuery('.cfp_radiorequired').each(function (index, element) { //Validation for number type custom field
        ...
        b = jQuery('.custom_error').each(function () {
            ...
            b = a + b;
            jQuery('.customcfperror').html(b);
        });
        var error = jQuery('.customcfperror').html();
        if (error == '') {
            return true;
        } else {
            return false;
...
jQuery('.input-box').addClass('cfp_input');
jQuery('.lable-text').addClass('cfp_label');
jQuery('.cfp_required').parent('.formtable').children('.cfp_label').children('label').append('<sup class="cfp_estric">*</sup>');
jQuery('.cfp_select_required').parent('.formtable').children('.cfp_label').children('label').append('<sup class="cfp_estric">*</sup>');
jQuery('.cfp_radiorequired').parent('.formtable').children('.cfp_label').children('label').append('<sup class="cfp_estric">*</sup>');
jQuery('.cfp_checkboxrequired').parent('.formtable').children('.cfp_label').children('label').append('<sup class="cfp_estric">*</sup>');
jQuery('.cfp_textarearequired').parent('.formtable').children('.cfp_label').children('label').append('<sup class="cfp_estric">*</sup>');
